<template>
  <div class="block">
    <div v-if="sectionData" class="bg-white p-5 rounded-2xl shadow-md">
      ...
      <button class='md:p-4 p-2 md:rounded-2xl rounded-md text-white bg-primary hover:bg-primary-700 flex items-center'>
        <font-awesome-icon icon="fa-solid fa-plus" class="text-xl"></font-awesome-icon>
      </button>
    </div>
