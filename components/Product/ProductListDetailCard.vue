<template>
  <div v-if="info" class="p-5 xl:p-8 product-card">
    <div class="grid md:grid-cols-12 grid-cols-1 md:gap-7">
      ...
      <div class="2xl:col-span-9 col-span-7">
        ...
        <p class="text-secondary-500">
          ...
          <u>
            <nuxt-link to="/" class="text-secondary-400"
              >Write a review?</nuxt-link
            >
          </u>
        </p>
        <h5 class="text-primary text-2xl font-bold mt-3">
        ...
        <p class="text-sm text-secondary-500 py-1">
          Product code: <span class="text-secondary-400">{{ info.code }}</span>
        </p>
        <p class="text-sm text-secondary-500 py-1">
          Brand: <span class="text-secondary-400">{{ info.brand }}</span>
        </p>
        <p class="text-sm text-secondary-500 py-1">
          Product tags:
          <button
        ...
        <button
          class="bg-primary hover:bg-primary-700 py-3 text-lg rounded-2xl px-5 font-bold text-white"
        >
