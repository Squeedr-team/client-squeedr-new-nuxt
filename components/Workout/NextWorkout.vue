<template>
  <div>
    <div class="bg-white rounded-2xl shadow-md block w-full">
      <div class="flex flex-wrap">
        ...
        <div
          class="w-full md:w-1/2 xl:w-full lg:border-t sm:border-t-0 border-t py-3 md:px-8 md:pt-0 px-5"
        >
          ...
          <div v-for="(i, idx) in 3" :key="idx" class="py-3">
            <div class="flex items-center">
              ...
              >
                <p
                  class="xl:text-2xl md:text-lg text-base text-primary-900 mb-0"
                >
                  {{ $moment().format('DD') }}
                </p>
              </div>
              <div>
                <h4 class="lg:text-lg sm:text-base text-sm pb-2">
                  <a>Cycling Routine</a>
                </h4>
